...
import com.atguigu.gmall0213.bean.OrderInfo
import com.atguigu.gmall0213.bean.dim.UserState
  ...
  def main(args: Array[String]): Unit = {
    ...
    val orderInfoWithUserDstream: DStream[OrderInfo] = orderInfoWithProvinceDstream.mapPartitions { orderInfoItr =>
      ...
      if(orderList.size>0) {
        ...
        val sql = "select id ,user_level ,  birthday  , gender  , age_group  , gender_name from gmall0213_user_info where id in ('" + userIdList.mkString("','") + "')"
