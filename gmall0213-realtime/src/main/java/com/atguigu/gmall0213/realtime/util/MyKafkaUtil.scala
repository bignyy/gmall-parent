...
object MyKafkaUtil {
  ...
  def getKafkaStream(topic: String,ssc:StreamingContext,offsets:Map[TopicPartition,Long],groupId:String): InputDStream[ConsumerRecord[String,String]]={
    ...
    // MyKafkaUtil.getKafkaStream->KafkaUtils.createDirectStream(
    // ssc,LocationStrategies.PreferConsistent,
    // ConsumerStrategies.Subscribe[String,String](Array(topic),kafkaParam,offsets))
    //def Subscribe[K, V](topics : scala.Iterable[java.lang.String], kafkaParams : scala.collection.Map[_root_.scala.Predef.String, java.lang.Object], offsets : scala.collection.Map[org.apache.kafka.common.TopicPartition, scala.Long])
